...
public class NewsMain extends AppCompatActivity implements  SwipeRefreshLayout.OnRefreshListener{
...
//    private String TAG = NewsMain.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layoutManager = new LinearLayoutManager(NewsMain.this);
        ...
        call.enqueue(new Callback<News>() {
            ...
            public void onResponse(Call<News> call, Response<News> response) {
                if (response.isSuccessful() && response.body().getArticle() != null){
                    ...
                    adapter = new Adapter(articles, NewsMain.this);
    ...
    private void initListener(){
        ...
        adapter.setOnIteamClickListner(new Adapter.OnIteamClickListner() {
            ...
            public void onItemClick(View view, int position) {
                ...
                Intent intent = new Intent(NewsMain.this, NewsDetailActivity.class);
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                if (query.length() > 2){
                    ...
                    Toast.makeText(NewsMain.this, "Type more than two letters!", Toast.LENGTH_SHORT).show();
                }
                return false;
            }
